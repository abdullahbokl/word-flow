  ...
  static Either<Failure, String> sanitizeScript(String raw) {
    ...
    try {
      ...
      if (bytes.length > 500 * 1024) {
        return const Left(ProcessingFailure('Input text exceeds maximum size of 500KB.'));
      }
      ...
      final sanitized = checked.replaceAll(RegExp(r'[\x00-\x08\x0B\x0C\x0E-\x1F]'), '');

      if (sanitized.trim().isEmpty) {
        return const Left(ProcessingFailure('Input text consists entirely of invalid characters.'));
      }
