...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i883.DatabaseHelper>(() => _i883.DatabaseHelper());
    gh.lazySingleton<_i862.ConnectivityMonitor>(
      () => _i862.ConnectivityMonitor(),
    );
    gh.lazySingleton<_i621.WordLocalSource>(
      () => _i621.WordLocalSourceImpl(gh<_i883.DatabaseHelper>()),
    );
    ...
    gh.lazySingleton<_i994.WordRepository>(
      () => _i296.WordRepositoryImpl(gh<_i621.WordLocalSource>()),
    );
