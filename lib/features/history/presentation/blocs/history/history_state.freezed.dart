...
mixin _$HistoryState {
  BlocStatus<List<HistoryItem>> get status;
  int get page;
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, page, hasReachedMax);

  @override
  String toString() {
    return 'HistoryState(status: $status, page: $page, hasReachedMax: $hasReachedMax)';
  }
}
...
abstract mixin class $HistoryStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {BlocStatus<List<HistoryItem>> status, int page, bool hasReachedMax});
}
    ...
    return _then(_self.copyWith(
      status: null == status
          ...
          : status // ignore: cast_nullable_to_non_nullable
              as BlocStatus<List<HistoryItem>>,
      page: null == page
          ? _self.page
...
extension HistoryStatePatterns on HistoryState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _HistoryState() when $default != null:
        return $default(_that.status, _that.page, _that.hasReachedMax);
      case _:
        return orElse();
    }
  }
