...
void main() {
  ...
  group('SaveProcessedWords', () {
    test('should return Right(null) and do nothing when word list is empty', () async {
      // act
    ...
    test('should properly map ProcessedWord entries to WordEntity and call repository', () async {
      ...
      final captured = verify(() => mockRepository.saveWords(captureAny())).captured.first as List<WordEntity>;
